      ...
      <div className="w-full p-4 shadow rounded-md bg-white border border-gray-200">
        ...
        <div className="relative mt-5 overflow-x-auto">
          <div className="w-full text-xs text-left">
            <div className=" text-[#000000] uppercase border-b">
          ...
          <div className="text-xs text-[#000000]  text-center uppercase border-b">
            <div className="py-1 flex justify-between items-start ">
              ...
              <div
                ...
                className="py-3 w-[25%] flex justify-center items-center font-medium"
              >
                <LuArrowDownNarrowWide />
              </div>
            </div>
          ...
          <div className={show ? "block border-b  bg-[#c6c6c622]" : "hidden"}>
            <div className="flex border-b text-xs text-center">
              <div className="py-3 pl-3 w-[14.5%]  whitespace-nowrap text-gray-400 font-normal">
                {" "}
                #3454
              </div>
