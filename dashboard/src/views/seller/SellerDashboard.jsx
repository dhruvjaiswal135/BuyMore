        ...
        <div className="px-2 md:px-7 py-12 ">
            ...
            <div
             ...
             md:grid-cols-2 lg:grid-cols-4 gap-7 ">
                ...
                px-4 py-6 bg-[#fbfbef] rounded-2xl ">
              ...
              ></div> */}
                ...
                <div className="flex justify-centre items-center
                px-4 py-6 bg-[#f3f3f3] rounded-2xl ">
                    <div className="flex flex-col w-full justify-start items-start gap-1
                    text-[#000000]">
                        <h2 className="text-4xl ">880</h2>
                        <div className="flex flex-row w-full justify-between items-center">
                            <div>
                                <span className="text-sm text-gray-500 font-light">
                                    Total Product Sale
                ...
                px-4 py-6 bg-[#eef9ff] rounded-2xl "
                >
                    <div
                ...
                px-4 py-6 bg-[#f7f3fb] rounded-2xl ">
                    ...
                    text-[#000000]">
                        ...
                        <div className="flex flex-row w-full justify-between items-center">
                            <div>
                                <span className="text-sm text-gray-500 font-light">Pending Orders</span>
                                <h3 className="text-xl text-[#175d21] font-medium">+30%</h3>
                                <span className="text-xs text-gray-500 font-light">
                                    This month
                                </span>
                ...
                <div className="w-full lg:w-3/12 lg:pl-4 mt-4 lg:mt-0  ">
                    <div className="w-full p-4 rounded-md bg-[#ffffff] text-[#000000]">
                        <div className="flex pb-2 border-b-[1px] justify-between items-center">
                            <h2 className="font-normal text-[14px] text-[#000000]">Recent Chat</h2>
                                ...
                                <li>
                                    <div className="flex items-center gap-1 ">
                                        ...
                                        <div className="flex w-full items-center justify-between">
                                            <h2 className="font-medium text-xs">Customer</h2>
                                ...
                                <li>
                                    <div className="flex mt-3 items-center gap-1 ">
                                        <div className="flex w-full items-center justify-between">
                                            ...
                                            <h2 className="font-medium text-xs">Seller</h2>
                                        </div>
