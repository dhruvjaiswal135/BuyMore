        ...
        <div className="min-h-screen flex flex-col md:flex-row bg-gray-100">
            <div className="flex justify-center items-center bg-[#3948ab] md:h-screen w-full md:w-3/5 p-5 md:p-0">
                <div className="flex flex-col items-center text-center">
                    ...
                    />
                    <h1 className="text-3xl font-semibold text-white mt-5">Welcome to Ecommerce</h1>
                    <p className="text-white text-lg">Just a couple of clicks and we start</p>
                </div>
            </div>

            <div className="flex justify-center items-center w-full md:w-2/5 p-8 bg-white shadow-lg rounded-lg">
                <div className="w-full max-w-md">
                    <h1 className="text-center text-3xl font-bold mb-10 text-[#00227B]">Register Now!</h1>
            ...
            >
              {loader ? (
                ...
                "Sign In"
                        ...
                        <p className="text-center text-gray-600">Already have an account? <Link className="font-bold text-[#3949AB]" to="/login">Sign In</Link></p>
